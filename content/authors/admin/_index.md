...
In Fall 2021, I taught two undergraduate courses on numerical methods. Continuing with my teaching interests, in Fall 2023, I expect to teach a subject on numerical methods (undergraduate level) and another on finite element methods (graduate level). I am serving the [**Journal of Peridynamics and Nonlocal Modeling**](https://www.springer.com/journal/42102/) as one of the associate editors and the [**Journal of Open Source Software (JOSS)**](https://joss.theoj.org/about) as topic editor. Recently, I joined the editorial team of [**Scientific Reports**](https://www.nature.com/srep/) as an Editorial Board Member.
